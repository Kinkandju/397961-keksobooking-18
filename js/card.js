...
(function () {
  ...
  window.card = {
    ...
    getFeaturesList: function (featureObject) {
    ...
    getPhotosList: function (photoObject) {
  ...
  var renderCards = function (cardData) {
    ...
    cardElement.querySelector('.popup__photos').appendChild(window.card.getPhotosList(cardData.offer.photos));
    cardElement.querySelector('.popup__features').innerHTML = '';
    cardElement.querySelector('.popup__features').appendChild(window.card.getFeaturesList(cardData.offer.features));
    ...
    cardElement.querySelector('.popup__close').addEventListener('keydown', window.card.onKeyEsc);
  };
